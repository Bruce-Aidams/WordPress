...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210629_221434_New-Schedule1_dms_4132b5e90b350aca6602_20210629221434_archive.zip';
    const ARCHIVE_SIZE       = '83947318';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '4132b5e-29221434';
    const SECONDARY_PACKAGE_HASH = 'e50d324-29221434';
    const VERSION            = '4.0.2';
