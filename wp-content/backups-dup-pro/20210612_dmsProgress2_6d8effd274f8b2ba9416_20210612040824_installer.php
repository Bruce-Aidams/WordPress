...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210612_dmsProgress2_6d8effd274f8b2ba9416_20210612040824_archive.zip';
    const ARCHIVE_SIZE       = '71446428';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '6d8effd-12040824';
    const SECONDARY_PACKAGE_HASH = '4fd68cc-12040824';
    const VERSION            = '4.0.2';
