...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210716_035118_New-Schedule1_dms_0f9bcf4a850ce9448694_20210716035118_archive.zip';
    const ARCHIVE_SIZE       = '85698752';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '0f9bcf4-16035118';
    const SECONDARY_PACKAGE_HASH = '75d83d4-16035118';
    const VERSION            = '4.0.2';
