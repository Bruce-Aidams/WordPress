...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210714_152319_New-Schedule1_dms_8f44119a4dd651271098_20210714152319_archive.zip';
    const ARCHIVE_SIZE       = '84383537';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '8f44119-14152319';
    const SECONDARY_PACKAGE_HASH = 'c8df1d6-14152319';
    const VERSION            = '4.0.2';
