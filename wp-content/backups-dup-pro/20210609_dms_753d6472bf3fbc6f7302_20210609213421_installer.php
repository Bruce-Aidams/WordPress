...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210609_dms_753d6472bf3fbc6f7302_20210609213421_archive.zip';
    const ARCHIVE_SIZE       = '67034307';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '753d647-09213421';
    const SECONDARY_PACKAGE_HASH = 'a813615-09213421';
    const VERSION            = '4.0.2';
