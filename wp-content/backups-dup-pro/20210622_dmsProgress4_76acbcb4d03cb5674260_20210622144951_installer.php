...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210622_dmsProgress4_76acbcb4d03cb5674260_20210622144951_archive.zip';
    const ARCHIVE_SIZE       = '72028676';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '76acbcb-22144951';
    const SECONDARY_PACKAGE_HASH = '682c5bb-22144951';
    const VERSION            = '4.0.2';
