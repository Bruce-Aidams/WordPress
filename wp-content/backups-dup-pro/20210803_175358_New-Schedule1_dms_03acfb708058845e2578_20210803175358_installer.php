...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210803_175358_New-Schedule1_dms_03acfb708058845e2578_20210803175358_archive.zip';
    const ARCHIVE_SIZE       = '86129413';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '03acfb7-03175358';
    const SECONDARY_PACKAGE_HASH = '2eb2d25-03175358';
    const VERSION            = '4.0.2';
