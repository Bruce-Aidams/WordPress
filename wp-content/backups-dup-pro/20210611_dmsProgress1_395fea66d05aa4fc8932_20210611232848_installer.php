...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210611_dmsProgress1_395fea66d05aa4fc8932_20210611232848_archive.zip';
    const ARCHIVE_SIZE       = '50866417';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '395fea6-11232848';
    const SECONDARY_PACKAGE_HASH = '2af8b97-11232848';
    const VERSION            = '4.0.2';
