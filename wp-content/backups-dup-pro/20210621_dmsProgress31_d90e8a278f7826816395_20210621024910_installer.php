...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210621_dmsProgress31_d90e8a278f7826816395_20210621024910_archive.zip';
    const ARCHIVE_SIZE       = '72020445';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = 'd90e8a2-21024910';
    const SECONDARY_PACKAGE_HASH = '36da8ef-21024910';
    const VERSION            = '4.0.2';
