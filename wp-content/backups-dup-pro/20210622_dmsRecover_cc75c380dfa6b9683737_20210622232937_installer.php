...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210622_dmsRecover_cc75c380dfa6b9683737_20210622232937_archive.zip';
    const ARCHIVE_SIZE       = '71946328';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = 'cc75c38-22232937';
    const SECONDARY_PACKAGE_HASH = '7f4f996-22232937';
    const VERSION            = '4.0.2';
