...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210704_dmsNew_d1b0617d3683ffe85458_20210704043134_archive.zip';
    const ARCHIVE_SIZE       = '84079003';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = 'd1b0617-04043134';
    const SECONDARY_PACKAGE_HASH = 'ae7a5be-04043134';
    const VERSION            = '4.0.2';
