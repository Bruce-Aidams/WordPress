...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210615_dmsProgress3_6cb0ecb67c0f8b6e5928_20210615021819_archive.zip';
    const ARCHIVE_SIZE       = '72210853';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '6cb0ecb-15021819';
    const SECONDARY_PACKAGE_HASH = 'c9fbf54-15021819';
    const VERSION            = '4.0.2';
