...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210707_155929_New-Schedule1_dms_c2332a6b02485c2a6180_20210707155929_archive.zip';
    const ARCHIVE_SIZE       = '84065070';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = 'c2332a6-07155929';
    const SECONDARY_PACKAGE_HASH = '3dbddc3-07155929';
    const VERSION            = '4.0.2';
