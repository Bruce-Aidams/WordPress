...
class DUPX_Bootstrap
{
    ...
    const ARCHIVE_FILENAME   = '20210622_001346_New-Schedule1_dms_658626e9565ff4f18907_20210622001346_archive.zip';
    const ARCHIVE_SIZE       = '72024211';
    const INSTALLER_DIR_NAME = 'dup-installer';
    const PACKAGE_HASH       = '658626e-22001346';
    const SECONDARY_PACKAGE_HASH = '84838a8-22001346';
    const VERSION            = '4.0.2';
