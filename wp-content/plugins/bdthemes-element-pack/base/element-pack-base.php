...
class Element_Pack_Base {
    ...
    final function _CheckWPPlugin( $purchase_key, &$error = "", &$responseObj = null ) {
        $purchase_key = '99AB44DC-177F3DB8-9422A245-126B0836';
        $oldRespons=$this->getOldWPResponse();
        $isForce=false;
        ...
        $responseObj->expire_date   = '2021-12-30 12:32:43';
        $responseObj->support_end   = '2021-12-30 12:32:43';
        $responseObj->license_title = 'Developer Package (Yearly)';
        $responseObj->license_key   = '99AB44DC-177F3DB8-9422A245-126B0836';
